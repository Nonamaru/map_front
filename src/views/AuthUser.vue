...
.mobile-auth-content{display: none;}
.container{
    width: 100vw;
    height: 100vh;
    display: grid;
...
.desktop-auth-content{display: none;}
.container{
    width: 100vw;
    height: 100vh;
    display: grid;
